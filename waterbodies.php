...
if ($_POST['faction']=="delete" && $_POST['waterbody_id'])
{
...
if ($_GET['faction']=="new" || $_GET['faction']=="edit")
{
	...
	if ($_GET['faction']=="edit" && $_GET['waterbody_id'])
	{
	...
	<?php 
		if($_GET['faction']=="edit") {print "<input type=\"hidden\" name=\"waterbody_id\" value=\"$waterbody_id\">\n";}
	?>
