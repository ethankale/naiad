...
<!-- Can't possibly figure out what the hidden input is for, but it seems
  to be messing up the precip_report page (two values for report_type).
...
<table class="formtable">
    ...
    <tr><td class="tdright"></td><td><input type="radio" name="report_type" value="raw" checked>Raw data</td></tr>
