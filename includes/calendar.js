...
var popUpCal = {
  ...
  init: function() {
    ...
    for (var i = 0; i < x.length; i++) {
     ...
     //   popUpCal.selectedMonth = new Date().getMonth();
    	...
    	if (this.value.length==10) popUpCal.selectedYear = this.value.substring(0,4);
    	if (this.value.length==10) popUpCal.selectedMonth = parseInt(this.value.substring(5,7))-1;
  ...
  drawCalendar: function(inputObj) {
    ...
    html += ' <td><a id="prevYear"><< Prev Yr</a></td>';
    html += ' <td><a id="nextYear">Next Yr>></a></td>';
    html += '</tr><tr>';
    html += ' <td><a id="prevMonth"><< Prev Mon</a></td>';
    html += ' <td><a id="nextMonth">Next Mon>></a></td>';
    html += '</tr></table>';
    ...
    // setup next and previous yr links
